...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Dragon" => "dragon.xuxiaolong@icloud.com" }
  # Or just: spec.author    = "Dragon"
  # spec.authors            = { "Dragon" => "dragon.xuxiaolong@icloud.com" }
  # spec.social_media_url   = "https://twitter.com/Dragon"
